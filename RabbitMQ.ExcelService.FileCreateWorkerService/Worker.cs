...
namespace RabbitMQ.ExcelService.FileCreateWorkerService
{
    public class Worker : BackgroundService
    {
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs @event)
        {
            ...
            var baseUrl = "https://localhost:7261/api/files";
        ...
        private DataTable GetTable(string tableName)
        {
            ...
            {
                var context = scope.ServiceProvider.GetRequiredService<RabbitMqexcelDbContext>();
